...
ابتدا این دستور رو بزنید تا سرتیفیکیت مربوط به ssl رو ایجاد کنه:
...
هر یوزر این پلتفرم با یه استرینگ رندوم شناسایی میشه که فرمت اون فرمت uuid هست
و alterId هم یه عدده که باید صفر بزارین برای غیرفعال شدن اتورایزشن منسوخ md5
email هم همون نام یوزر هست که میتونین برای راحتی خودتون اضافه کنین اختیاریع  
